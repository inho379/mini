...
<form method="post"
	action="<%=request.getContextPath()%>/Ninsert/n_insert_pro.jsp"
	...
	<div class="tbl_frm01">
		<table class="table table-bordered" style="width : 430px;">
			<tbody>
				...
				<tr>
					...
					<td>
						<div id="autosave_wrapper">
							<input type="text" name="nName"  style="width:100%;"
				...
				<tr>
					<th scope="row">색상</th>
					<td>
						<input type="text" name="nColor" value="" style="width:100%;"
				...
				<tr>
					<th scope="row">스펙</th>
					<td>
						<input type="text" name="nNspec" value=""  style="width:100%;"
							required="" class="frm_input"
							maxlength="255">
					</td>
				</tr>
				<tr>
					<th scope="row">수량</th>
					<td>
						<input type="text" name="nCount" value="" style="width:100%;"
							required="" class="frm_input"
							maxlength="255">
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="nSday" value="" style="width:100%;"
							required="" class="frm_input" 
							maxlength="255">
					</td>
				</tr>
				<tr>
					<th scope="row">가격</th>
					<td>
						<input type="text" name="nPrice" value="" style="width:100%;"
							required="" class="frm_input" 
							maxlength="255">
					</td>
				</tr>
		...
		<div style="margin-bottom: 30px; ">
			...
			<input type="submit" value="상품등록" class="btn btn-primary btn-block" style="width:150px;">
		</div>	
	</div>
</form>
